param(
    ...
    [int]$SpawnCountBaseMax = 2,
    [int]$SingleSpawnLimit = 1,
    [int]$SingleSpawnLimitMax = 2,
    ...
    [int]$VeryLikelyProbability = 35,
    [int]$VeryLikelyProbabilityMax = 55,
    [int]$AboveAvarageProbability = 30,
    [int]$AboveAvarageProbabilityMax = 48,
    [int]$SomewhatinthemiddleProbability = 22,
    [int]$SomewhatinthemiddleProbabilityMax = 38,
    [int]$UnlikelyProbability = 16,
    [int]$UnlikelyProbabilityMax = 30,
    [int]$VeryUnlikelyProbability = 8,
    [int]$VeryUnlikelyProbabilityMax = 18,
    [int]$HaveyouseenhimProbability = 5,
    [int]$HaveyouseenhimProbabilityMax = 12,
